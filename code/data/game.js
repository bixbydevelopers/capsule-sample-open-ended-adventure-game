...
module.exports = [
  // Scenes of the adventure game
  {
    ...
    actions: [
       ...
       {name: ACT.WALK, tags: ["walk", "stroll", "run", "escape"], say: "You go a few steps and... bang! You hit a wall!"},
      ...
      objects: [ //objects in the dark room, object names should match the symbols in ObjectName.model.bxb enum
        {
          ...
          responses: [
            ...
            {action: ACT.WALK, conditions: [{state: STATE.CLOSE}], say: "You go a few steps but then bang! You hit the door!"},
